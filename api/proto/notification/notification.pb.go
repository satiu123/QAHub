...
type GetNotificationsRequest struct {
	...
	Limit         int32                  `protobuf:"varint,2,opt,name=limit,proto3" json:"limit,omitempty"`                             // 每页数量，默认由服务端兜底
...
const file_api_proto_notification_notification_proto_rawDesc = "" +
	"\n" +
	")api/proto/notification/notification.proto\x12\fnotification\x1a\x1cgoogle/api/annotations.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xa0\x02\n" +
	...
	"\auser_id\x18\x01 \x01(\x03R\x06userId\x12'\n" +
	"\x0fnotification_id\x18\x02 \x01(\tR\x0enotificationId\"0\n" +
	...
	"\n" +
	"target_url\x18\x06 \x01(\tR\ttargetUrl2\xaf\x05\n" +
	...
	"\n" +
	"MarkAsRead\x12\x1f.notification.MarkAsReadRequest\x1a .notification.MarkAsReadResponse\"%\x82\xd3\xe4\x93\x02\x1f:\x01*\"\x1a/api/v1/notifications/read\x12\x86\x01\n" +
	"\x12DeleteNotification\x12'.notification.DeleteNotificationRequest\x1a\x16.google.protobuf.Empty\"/\x82\xd3\xe4\x93\x02)*'/api/v1/notifications/{notification_id}\x12\x87\x01\n" +
...
var file_api_proto_notification_notification_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_api_proto_notification_notification_proto_goTypes = []any{
	...
	(*SubscribeNotificationsRequest)(nil), // 8: notification.SubscribeNotificationsRequest
...
var file_api_proto_notification_notification_proto_depIdxs = []int32{
	10, // 0: notification.Notification.created_at:type_name -> google.protobuf.Timestamp
	...
	8,  // 6: notification.NotificationService.SubscribeNotifications:input_type -> notification.SubscribeNotificationsRequest
	...
	11, // 9: notification.NotificationService.DeleteNotification:output_type -> google.protobuf.Empty
	7,  // 10: notification.NotificationService.GetUnreadCount:output_type -> notification.GetUnreadCountResponse
